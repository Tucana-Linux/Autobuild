...
FILES=$(find . -maxdepth 1 -type f -not -path "./.git*" && find ./xorg -type f -not -path "./apps" && find ./base -type f && find ./i3 -type f && find  ./python-modules -type f  && find ./xfce4 -type f && find ./gnome -type f)
